                        ...
                        <div class="caption-kegiatan">
                            <div class="caption d-flex">
                                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2 mt-2">
                                    <a href="{{ route('event.show', $event->id_event) }}"
                                        ...
                                        style="text-decoration: none; color: black; font-weight: bold; margin: 20px 0;">{{
                                        $event->nama }}</a>
                                </h3>

                            </div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm" style="color: #4b5563;">Hosted by: <span
                            ...
                            <div class="mt-2">
                                ...
                                <div class="progress" style="position: relative;">
                                    <div class="progress-bar" role="progressbar" style="width: {{$event->progress_event}};"
